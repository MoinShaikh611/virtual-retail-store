  ...
  const data = useStaticQuery(graphql`
    {
      BrandData: allFile(
        filter: {
          relativeDirectory: { eq: "TestimonialCarousel/BrandTestimonial" }
      ...
      BrandBrandImages: allFile(
        filter: {
          ...
          relativeDirectory: { eq: "TestimonialCarousel/ByBrands/brandImage" }
      ...
      BrandUserImages: allFile(
        filter: {
          sourceInstanceName: { eq: "images" }
          relativeDirectory: { eq: "TestimonialCarousel/ByBrands/userImage" }
          extension: { regex: "/(png)|(jpg)|(jpeg)/" }
        }
      ) {
        nodes {
          ...
          <div className="testimonial-carousel-slides" ref={SlidesRef}>
            {brandData.map((bd: any, i: number) => (
              <div
                ...
                key={bd.childMarkdownRemark.frontmatter.userName + i}
              >
                <GatsbyImage
                ...
                <div className="testimonial-carousel-slide-brand-container">
                  ...
                  <p>{bd.childMarkdownRemark.frontmatter.userDesignation}</p>
                </div>
